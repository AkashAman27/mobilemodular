...
export default function NewNewsInsight() {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Create a new news article or insight</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Best practices for writing engaging articles</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3 text-sm text-gray-600">
                ...
                <div className="flex items-start space-x-2">
                  <span className="font-medium text-green-600">✓</span>
                  <span>Keep excerpts concise but informative (150-200 characters)</span>
                </div>
                <div className="flex items-start space-x-2">
                  <span className="font-medium text-green-600">✓</span>
                  <span>Use relevant categories to help readers find content</span>
                </div>
                <div className="flex items-start space-x-2">
                  <span className="font-medium text-green-600">✓</span>
                  <span>Include industry keywords for SEO benefits</span>
                </div>
                <div className="flex items-start space-x-2">
                  <span className="font-medium text-green-600">✓</span>
                  <span>Add high-quality images to improve engagement</span>
                </div>
              </div>
            </CardContent>
          </Card>
